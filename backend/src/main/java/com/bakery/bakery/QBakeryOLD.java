...
public class QBakeryOLD {
    public class TableDef {
        ...
        public TableDef filter(Map<String, Object> filter) {
            List<Object> list = new ArrayList<>();
            for (Map.Entry<String, Object> e : filter.entrySet()) {
                list.add(e.getKey());
                list.add(e.getValue());
            }
            return filter(list.toArray());
        }
        
        public TableDef filter(Object... kv) {
            ...
            for (int i = 0; i < kv.length; i += 2) {
                ...
                // map alias -> real field
                String realField = fieldMap.getOrDefault(colKey, (String) colKey);

                appendWhere(alias + "." + "\"" + realField + "\"" + " = ?");
                params.add(val);
...
//        }
    ...
    public QBakeryOLD setFields(String fieldsCommaSeparated) {
    ...
    public QBakeryOLD groupBy(String field) {
        groupList.add(field);
        return this;
    }

    public QBakeryOLD having(String condition) {
        havingList.add(condition);
        return this;
    }

    public QBakeryOLD orderBy(String field, boolean asc) {
        orderList.add(field + (asc ? " ASC" : " DESC"));
        return this;
    }

    public QBakeryOLD limit(int l) {
        this.limit = l;
        return this;
    }

    public QBakeryOLD offset(int o) {
        this.offset = o;
        return this;
    }

    public QBakeryOLD insertInto(String table) {
        this.command = "INSERT";
        this.targetTable = table;
        return this;
    }

    public QBakeryOLD value(Map<String, Object> values) {
        insertValues.putAll(values);
        return this;
    }

    public QBakeryOLD update(String table) {
        this.command = "UPDATE";
        this.targetTable = table;
        return this;
    }

    public QBakeryOLD set(String col, Object val) {
    ...
    public QBakeryOLD deleteFrom(String table) {
        this.command = "DELETE";
        this.targetTable = table;
        return this;
    }
