...
public class IngredientService implements ApiHandler {
    ...
    public void list(HttpServletRequest req, HttpServletResponse res) {
        ...
        qb.addTable("Ingredient").field("id, name, quantity, unit, price, note, creDate");
    ...
    public void load(HttpServletRequest req, HttpServletResponse res) {
        ...
        QBakery qb = new QBakery();
        qb.addTable("Ingredient").filter(filter).field("id, name, quantity, unit, price, note, creDate");
        List<Map<String, Object>> list = qb.listData();
